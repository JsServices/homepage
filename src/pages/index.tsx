      ...
      <Wrapper>
        ...
        <div className="space-y-44 mb-44">
          <Box
            ...
            linkTo="/jsboard"
            left="no"
            desc="Imagine a free, open-source forums software, built for the modern
          ...
          <Box
            ...
            desc="Quartz Studios is a Minecraft server creation studio that creates
...
WJS.page({ title: "My WaveJS site" }, Home);
